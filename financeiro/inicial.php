            ...
            <div id="page-inner">
                ...
                <div class="col-md-6">
                    <div class="panel panel-primary text-center no-boder bg-color-green">
                        <div class="panel-body">
                            ...
                            <h3>R$ <?= $total_entrada[0]['total'] != '' ? number_format($total_entrada[0]['total'], 2, ',', '.') : number_format(0, 2, '.', '.') ?></h3>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="panel panel-primary text-center no-boder bg-color-red">
                        <div class="panel-body">
                            <i class="fa fa-bar-chart-o fa-5x"></i>
                            <h3>R$ <?= $total_saida[0]['total'] != '' ? number_format($total_saida[0]['total'], 2, ',', '.') : number_format(0, 2, '.', '.') ?></h3>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Últimos 10 lançamentos de movimentos
                                </div>
                                <div class="panel-body">
